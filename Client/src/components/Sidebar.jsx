...
const Sidebar = () => {
  ...
  return (
    <div className='w-full h-full grid grid-cols-[48px,1fr] bg-gray-100'>
                ...
                <div className=' h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
...

                    {
                        allUser.map((conv,index)=>{
                            return(
                                <NavLink to={"/"+conv?.userDetails?._id} key={conv?._id} className='flex items-center gap-2 py-3 px-2 border border-transparent hover:border-primary rounded bg-slate-300 hover:bg-slate-100 cursor-pointer'>
                                    <div>
                                        <Avatar
