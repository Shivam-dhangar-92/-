...
const RegisterPage = () => {
  ...
  return (
    <div className='mt-5'>
        <div className='bg-slate-800 rounded-3xl w-full max-w-md  rounded overflow-hidden p-4 mx-auto text-teal-50'>
          ...
          <form className='grid gap-4 mt-5' onSubmit={handleSubmit}>
              ...
              <div className='flex flex-col gap-1'>
                <label htmlFor='profile_pic'>Photo :
                  ...
                  <div className='h-14 bg-slate-600 flex justify-center items-center rounded hover:border-white cursor-pointer'>
                ...
                <input
                  ...
                  id='profile_pic'
                  name='profile_pic'
                  className='bg-slate-600 px-2 py-1 focus:outline-primary hidden'
